        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                if(mysqli_num_rows($row)>0){
                  $query = "INSERT INTO `trans_list` (`date`, `mobile`, `s_description`, `price`, `wight`, `amount`)
                   VALUES ( now(), '$moba', '$dis', '$price2', '$wight ', '$amount') ;";
                  ...
                  header("location: customer.php?moba=".$moba);
                }
              }
      ...
      <h1>Cash-In</h1>
        <form action="" method="POST">
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" onkeypress="return onlyNumberKey(event)" id="fname" name="moba" placeholder="Enter Costomer Mobile No" required>
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="lname" name="dis" placeholder="Enetre Paddy name here" required>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" onkeypress="return onlyNumberKey(event)" id="lname" name="price" placeholder="Enter Price Per MON" required>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" onkeypress="return onlyNumberKey(event)" id="lname" name="wight" placeholder="Enter Wight In KG" required>
            </div>
          </div>
